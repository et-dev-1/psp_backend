...
export const DEFAULT_ADMIN_EMAIL = String(process.env.DEFAULT_ADMIN_EMAIL || 'experts.town.ab@gmail.com').trim()
export const DEFAULT_ADMIN_PASSWORD = String(process.env.DEFAULT_ADMIN_PASSWORD || 'Admin1234!').trim()
...
export const SIGNUP_MAX_ATTEMPTS = toNumber(process.env.SIGNUP_MAX_ATTEMPTS, 10)
