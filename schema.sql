...
VALUES
  ...
  ('stripe_payment_fixed_cost', '0'),
  ('stripe_payment_percent_cost', '0'),
  ('swish_payment_fixed_cost', '0'),
  ('swish_payment_percent_cost', '0'),
  -- Accounting Account Mapping
  ('account_main_bank', '1930'),
  ('account_stripe_clearing', '1580'),
  ('account_tax', '1630'),
  ('account_seller_liability', '2890'),
  ('account_output_vat', '2610'),
  ('account_output_vat_reverse', '2614'),
  ('account_input_vat', '2640'),
  ('account_commission_revenue', '3001'),
  ('account_stripe_fees', '6040'),
